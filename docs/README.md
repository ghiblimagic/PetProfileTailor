...
| [`app/api/user/likes/route.ts`](../app/api/user/likes/route.ts), [`context/LikesContext.tsx`](../context/LikesContext.tsx), [`LikesWrapper.tsx`](../wrappers/LikesWrapper.tsx), [`hooks/useLikeState.ts`](../hooks/useLikeState.ts) | [user-likes-route.md](notes/app/api/user-likes-route.md), [togglelike-route.md](notes/app/api/togglelike-route.md) |
