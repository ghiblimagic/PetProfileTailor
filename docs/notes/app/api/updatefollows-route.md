...
`PUT /api/user/updatefollows` — toggles a follow edge for the authenticated user. Called by [`FollowButton.tsx`](../../../components/ReusableSmallComponents/buttons/FollowButton.tsx).
